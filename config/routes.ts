...
export default [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/base/lab/detail',
        name: 'labDetail',
        hideInMenu: true,
        component: './base/lab/detail',
        access: 'hasPrivilege',
      },
      {
        path: '/base/semester',
        name: 'semester',
        component: './base/semester',
        access: 'hasPrivilege',
      },
      {
        path: '/base/semester/detail',
        name: 'semesterDetail',
        hideInMenu: true,
        component: './base/semester/detail',
        access: 'hasPrivilege',
      },
      {
        path: '/base/schedule',
        name: 'schedule',
        component: './base/schedule',
        access: 'hasPrivilege',
      },
      {
        path: '/base/schedule/detail',
        name: 'scheduleDetail',
        hideInMenu: true,
